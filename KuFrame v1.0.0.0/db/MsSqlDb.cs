...
namespace Ku.db
{
    public class MsSqlDb : KuDb
    {
        ...
        protected override DbConnection InitConnection() => new SqlConnection(ConnectString);
        protected override KuSqlBuilder InitBuilder() => new MsSqlBuilder();
        public int GetCurrentRowID(string table) => Convert.ToInt32(ExecuteScalar(((MsSqlBuilder)Builder).GetCurrentRowID(table))) + 1;
    }
